let db = require('../config/db'); // let db=require("./db.js")
...
function check(obj) {
    ...
    var ziplen = obj.phone.length;
    var zipdig = obj.phone.search(/\D/);
    ...
    if (varify_input) {
        ...
        db.users.find({ email: userobj.email }).toArray((err, user) => {
            ...
            if (err) {
                ...
                userobj.starts = 0;
                userobj.daysActive = 0;
                userobj.daysCleaned = 0;
                userobj.pixPoints = 0;
                            ...
                            db.users.updateOne(
                                userobj,
                                {
                                    ...
                                    $push: {
                                        chats: {
                                            name: 'Live',
                                            id: '5d435235d269d7285c9f0f44',
                                            pic: '/data/uploads/Live/Live.jpg'
                                        }
                                    }
                                },
                                (err, succ) => {
